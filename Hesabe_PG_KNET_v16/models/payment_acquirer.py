...
from odoo.addons.Hesabe_PG_KNET_v16.models.hesabecrypt import encrypt, decrypt
from odoo.addons.Hesabe_PG_KNET_v16.models.hesabeutil import checkout
...
class PaymentAcquirerHesabe(models.Model):
    ...
    code = fields.Selection(selection_add=[('Hesabe_PG_KNET_v16', 'Hesabe KNET')], ondelete={'Hesabe_PG_KNET_v16': 'set default'})
    merchant_code = fields.Char(string="Merchant Code", help="This is Merchant Code", required_if_provider='Hesabe_PG_KNET_v16')
    secret_key = fields.Char(string="Secret Key", help="This is Secret Key", required_if_provider='Hesabe_PG_KNET_v16')
    access_code = fields.Char(string="Access Code", help="This is Access Code", required_if_provider='Hesabe_PG_KNET_v16')
    iv_key = fields.Char(string="IV Key", help="This is IV Key", required_if_provider='Hesabe_PG_KNET_v16')
    api_version = fields.Char(string="API Version", help="This is API Version", required_if_provider='Hesabe_PG_KNET_v16', default='2.0')
    production_url = fields.Char(string="Production Url", help="This is Production Url", required_if_provider='Hesabe_PG_KNET_v16')
    sandbox_url = fields.Char(string="Sandbox Url", help="This is Sandbox Url", required_if_provider='Hesabe_PG_KNET_v16')
    ...
    def _get_hesabe_form_generate_values(self, acqid,currencyid,partnerid,referenceno,providr,amount):
        ...
        payload = {
            ...
            "amount": amount,
            "responseUrl": urls.url_join(base_url, '/payment/hesabe/%s/return' % ('knet' if self.code == 'Hesabe_PG_KNET_v16' else 'mpgs')),
            "paymentType": 1 if self.code == 'Hesabe_PG_KNET_v16' else 2,
            "version": acqid.api_version,
            "orderReferenceNumber": referenceno,
            "failureUrl": urls.url_join(base_url, '/payment/hesabe/%s/fail' % ('knet' if self.code == 'Hesabe_PG_KNET_v16' else 'mpgs')),
